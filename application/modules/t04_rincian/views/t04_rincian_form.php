        ...
        <div class="box box-info">
            ...
            <form action="<?php echo $action; ?>" method="post" class="form-horizontal">
                <div class="box-body">
					...
					<div class="form-group">
                        <label class="col-sm-2 control-label" for="int">Kelas <?php echo form_error('kelas') ?></label>
                        <div class="col-sm-3">
                    ...
                    <div class="form-group">
        				<div class="col-md-12 mb-0">
        					<table class="table">
                                ...
                                <?php if ($this->uri->segment(2) == "updateCostsheet") { ?>
                                    <!-- update detail -->

                                    <?php foreach ($detailRincian as $key => $dtl) { ?>
                                        <script type="text/javascript">
                                            ++j;
                                        </script>
                                        <tr id="trRincian<?php echo $key ?>">
                                            ...
                                            <td>
                                                <input type="text" class="form-control" name="nominal[]" id="nominal[<?php echo $key ?>]" onblur="calculate(<?php echo $key ?>)" onkeyup="calculate(<?php echo $key ?>)">
                                            </td>
                                        </tr>
                                    <?php } ?>
                                ...
                                <?php } else { ?>
                                    ...
                                    <tr id="trRincian0">
                                        ...
                                        <td>
                                            <input type="text" class="form-control" name="nominal[]" id="nominal[0]" onblur="calculate(0)" onkeyup="calculate(0)">
                                        </td>
                                        <td>&nbsp;</td>
                                    </tr>
